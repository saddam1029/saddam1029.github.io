...
title: 'Etmaen',
category: 'Android App',
description: 'A bilingual digital healthcare platform connecting clients with healthcare providers for medical service discovery, appointment booking, real-time communication, and service management.',
overview: 'Etmaen is a bilingual healthcare Android application designed to connect clients with localized healthcare providers such as doctors and nurses. The platform supports role-based experiences for Clients, Providers, and Admins. Clients can browse and search medical services, find providers, compare service fees, schedule appointments, communicate through real-time chat, and receive booking notifications. Providers can create and manage their medical service offers, respond to appointment requests, and communicate with clients. An administrative portal provides user oversight and provider management. The application supports English and Arabic with persistent language selection.',
role: 'Android Developer',
platform: 'Android',
technologies: [
'Kotlin',
...
'Secure user registration, login, and email-based password recovery',
'Medical services catalog with categories including Nursing, Doctor Visit, Lab Test, Cupping Therapy, Physical Therapy, Vaccination, Cosmetic Clinic, and Special Needs Transportation',
'Provider search and filtering by location, address, and service fees',
'Appointment booking with date and time selection and validation against past dates and times',
'Real-time appointment workflow allowing providers to accept or decline booking requests',
'Provider service offer management with create, update, and delete functionality',
'Real-time one-to-one chat between clients and healthcare providers',
'Automated notification logging for appointment status changes',
'Admin dashboard for user oversight and provider management',
'Persistent English and Arabic language switching',
'Firebase Cloud Messaging for real-time notification delivery',
'Responsive service and appointment lists using RecyclerView',
'Persistent local session and language preferences using SharedPreferences'
],
images: [
...
liveUrl: '',
  ...
  title: 'My Diary',
  category: 'Android App',
  description: 'A private and feature-rich digital diary app for writing, organizing, securing, and analyzing personal memories with rich text, media attachments, timelines, mood insights, and biometric protection.',
  overview: 'My Diary is a comprehensive Android journaling application designed to help users capture and organize their daily thoughts, memories, and personal experiences. Users can create rich diary entries with formatted text, images, audio recordings, emojis, stickers, tags, backgrounds, and mood information. The app provides powerful organization through search, sorting, pinning, calendar-based filtering, and customizable timelines for grouping memories and milestones. A dedicated insights section analyzes mood patterns and diary activity through visual charts. User privacy is a major part of the application, with support for PIN, pattern lock, fingerprint authentication, and recovery options. The app also includes onboarding and multi-language support with a dynamic theme system for personalized light and dark visual styles.',
  role: 'Android Developer',
  platform: 'Android',
  technologies: [
  'Kotlin',
  ...
  features: [
  'Rich diary entry creation with text formatting, alignment, text size, bold, italic, underline, and strikethrough',
  'Attach images, audio recordings, emojis, stickers, tags, backgrounds, and mood information to diary entries',
  'Voice recording with audio waveform visualization and playback',
  'Search, sort, pin, and bulk delete diary entries',
  'Calendar view for browsing diary entries by specific dates',
  'Interactive month navigation with highlighted dates containing diary entries',
  'Timeline and memory management for organizing travel, milestones, and other memory collections',
  'Timeline details with cover images, descriptions, and chronological memory records',
  'Mood analytics with visual donut and bar charts for All Time, Week, Month, and Year periods',
  'Multiple app themes with dynamic colors, backgrounds, icons, and visual styles',
  'PIN, pattern lock, and fingerprint authentication for protecting private diary data',
  'Recovery question support for recovering or resetting the application lock',
  'Onboarding flow with language selection and customizable application language',
  'Persistent local data storage using Room Database',
  'Lifecycle-aware reactive UI using Kotlin Flow and StateFlow',
  ...
  'assets/projects/my-diary/05.png',
  'assets/projects/my-diary/06.png',
  'assets/projects/my-diary/07.png',
  'assets/projects/my-diary/08.png',
  'assets/projects/my-diary/09.png',
  'assets/projects/my-diary/10.png',
  'assets/projects/my-diary/11.png',
  'assets/projects/my-diary/12.png',
  'assets/projects/my-diary/13.png',
  ],
  githubUrl: '',
  liveUrl: '',
  },
...
category: 'Android App',
description: 'A feature-rich Android mapping and navigation application built with Google Maps, providing satellite and styled maps, 3D perspectives, live location, route visualization, GPS camera, compass, voice search, geocoding, and location-based utilities.',
overview: 'Live Earth Map is a comprehensive Android mapping application focused on exploring locations, navigation, and GPS-based utilities. The app integrates the Google Maps SDK to provide satellite, light, and dark map styles, 3D map perspectives, live GPS location, route drawing, and location search. It also includes a GPS camera that captures photos with the current address, coordinates, and date overlaid on the image, a digital compass powered by Android sensors, voice-activated location search, geocoding and reverse geocoding, Google Maps deep-link integration, and multi-language support. The application uses Android permission management to safely handle location and camera features.',
role: 'Android Developer',
platform: 'Android',
technologies: [
'Kotlin',
...
features: [
'Google Maps integration with Normal, Satellite/Hybrid, Light, and Dark map styles',
'Custom Google Maps JSON styling using MapStyleOptions',
'3D map perspective with building visualization, camera tilt, and zoom controls',
'Live GPS location with automatic map positioning',
'Route drawing between locations using Google Directions API and decoded polylines',
'Custom distance markers displaying route distance directly on the map',
'GPS Camera using CameraX with address, latitude, longitude, date, and time overlays',
'Digital compass using accelerometer and magnetometer sensor data',
'Smooth compass rotation using Android ObjectAnimator',
'Voice-activated location search using SpeechRecognizer and RecognizerIntent',
'Forward and reverse geocoding for address and coordinate conversion',
'Google Maps deep linking for Street View, navigation, map search, and nearby places',
'Multi-language support with runtime language switching and persistent locale preferences',
'Centralized location and camera permission management using Activity Result APIs'
],
images: [
'assets/projects/live-earth-map/01.jpeg',
'assets/projects/live-earth-map/02.png',
'assets/projects/live-earth-map/03.png',
'assets/projects/live-earth-map/04.png',
'assets/projects/live-earth-map/05.png',
'assets/projects/live-earth-map/06.png',
'assets/projects/live-earth-map/07.png',
'assets/projects/live-earth-map/08.png',
],
githubUrl: '',
liveUrl: '',
},
```js
{
  ...
  category: 'Android App',
  description: 'A complete offline productivity app for managing tasks, subtasks, notes, scheduled reminders, full-screen alarms, voice-to-text input, custom categories, themes, and multi-language support.',
  overview: 'Notes & To-do List is a 100% offline Android productivity application designed to help users organize daily tasks, subtasks, notes, and scheduled reminders. The app supports hierarchical tasks with Room database relationships, task search and filtering, custom categories, pinned notes, voice-to-text input, notification reminders, and precise full-screen alarms. It also includes dynamic accent color themes, onboarding, and localization across 12 languages. The application follows Clean Architecture and MVVM with Repository and Use Case layers, providing a structured and maintainable Android architecture.',
  role: 'Android Developer',
  platform: 'Android',
  technologies: [
    'Kotlin',
  ...
  features: [
    'Task management with daily, future, and completed task groups',
    'Hierarchical subtasks with Room database relationships and cascade deletion',
    'Task search, category filtering, and sorting options',
    'Daily progress tracker showing task completion percentage',
    'Notes creation with search, pinning, and categorized display',
    'Scheduled task reminders using WorkManager notifications',
    'Precise full-screen alarms using AlarmManager and Foreground Service',
    'Looping alarm ringtone and vibration with lock-screen alarm support',
    'Voice-to-text input for creating tasks and notes using SpeechRecognizer',
    'Custom category creation and management with color selection',
    'Dynamic application accent color and theme customization',
    'Onboarding flow with ViewPager2 and DotsIndicator',
    'Support for 12 languages with runtime language switching',
    'Boot-time alarm rescheduling after device restart',
    'Persistent offline data storage using Room Database and SharedPreferences',
    'Settings for language, themes, notifications, reminders, sharing, feedback, and privacy policy'
  ],
  images: [
    'assets/projects/notes-todo/02.png',
    'assets/projects/notes-todo/03.png',
    'assets/projects/notes-todo/04.png',
    'assets/projects/notes-todo/05.png',
    'assets/projects/notes-todo/06.png',
    'assets/projects/notes-todo/07.png',
  ],
  githubUrl: '',
  liveUrl: '',
},
...
title: 'WIFI Manager',
category: 'Android App',
description: 'A comprehensive Android WiFi and hotspot management app for monitoring network connections, managing hotspot usage, testing internet speed, tracking data consumption, and securely sharing WiFi networks.',
overview: 'WIFI Manager is a feature-rich Android application designed to help users monitor and manage their WiFi, mobile data, and hotspot activity from a single app. It provides real-time hotspot monitoring with connected-device information and smart limits that can automatically disable the hotspot based on a timer, battery level, data usage, or device temperature. The app also includes an internet speed test with download, upload, ping, jitter, and packet-loss measurements, per-app data usage tracking, WiFi QR code generation and scanning, and detailed network information including internal and external IP addresses, service provider, and server location. The application uses MVVM architecture with Kotlin Coroutines and StateFlow for reactive UI updates, while foreground services and Android system APIs handle background monitoring and network-related functionality.',
role: 'Android Developer',
platform: 'Android',
technologies: [
'Kotlin',
...
features: [
'Hotspot monitoring with real-time status, elapsed time, and connected device count',
'Smart hotspot limits based on Timer, Battery level, Data usage, and Device temperature',
'Automatic hotspot shutdown when a configured usage limit is reached',
'Internet speed test with Download, Upload, Ping, Jitter, and Packet Loss measurements',
'Real-time speedometer interface with animated testing progress',
'Per-app data usage tracking with Daily, Weekly, and Monthly statistics',
'WiFi QR code generator for quickly sharing network credentials',
'QR code scanner for easily connecting to WiFi networks',
'Detailed WiFi and network information including internal and external IP addresses',
'Network information including service provider and server location',
'Real-time network connectivity and WiFi/mobile data status monitoring',
'Foreground service for continuous hotspot limit monitoring in the background',
'Battery and device temperature monitoring for smart hotspot protection',
'Modern Material 3 interface with responsive UI components',
'Multi-step onboarding experience introducing the app features',
'Permission management for WiFi scanning, usage statistics, and system functionality',
'Android compatibility handling for modern system restrictions and hotspot settings'
],
images: [
'assets/projects/wifi-manager/01.png',
'assets/projects/wifi-manager/02.png',
'assets/projects/wifi-manager/03.png',
'assets/projects/wifi-manager/05.png',
'assets/projects/wifi-manager/06.png',
'assets/projects/wifi-manager/07.png',
'assets/projects/wifi-manager/08.png',
'assets/projects/wifi-manager/09.png',
],
githubUrl: '',
liveUrl: '',
},
