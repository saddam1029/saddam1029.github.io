...
liveUrl: '',
  ...
  title: 'Waqt',
  category: 'Android App',
  description: 'A prayer time and Islamic utility Android application that helps users track daily prayer times, receive prayer alarms, practice daily Dhikr, and use a digital Tasbeeh counter.',
  overview: 'Waqt is a prayer timer application designed to help users stay informed about their daily prayer schedule and maintain their daily Dhikr routine. After the splash screen, the app presents a daily Dhikr reminder featuring phrases such as Alhamdulillah, Salawat, and Astaghfar. The home screen prominently displays the upcoming prayer, its scheduled time, and a live countdown showing the remaining time. Users can view all daily prayer times, manually adjust prayer times when needed, configure prayer alarms, select custom alarm sounds from their device, and manage the required permissions. The app also includes a digital Tasbeeh counter for Subhan Allah, Alhamdulillah, and Allahu Akbar with animated counting feedback. Light and dark themes are available for a personalized experience.',
  role: 'Android Developer',
  platform: 'Android',
  technologies: [
  'Kotlin',
  ...
  features: [
  'Splash screen with a daily Dhikr reminder dialog',
  'Daily Dhikr including Alhamdulillah, Salawat, Astaghfar, and more',
  'Home screen with the upcoming prayer displayed prominently',
  'Live countdown showing the remaining time until the next prayer',
  'Complete daily prayer schedule with the next prayer highlighted',
  'Manual prayer time configuration and adjustment',
  'Prayer alarms with individual on/off controls',
  'Custom prayer alarm sounds selected from the device',
  'Android notification and alarm scheduling using AlarmManager',
  'Digital Tasbeeh counter for Subhan Allah, Alhamdulillah, and Allahu Akbar',
  'Animated Tasbeeh counting experience with interactive feedback',
  'Light and dark theme support',
  'Permission management for alarms, notifications, and required app functionality',
  'Simple and user-friendly Islamic-themed interface'
  ],
  images: [
